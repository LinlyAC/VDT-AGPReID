...
class PCB(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        b11_feat, b12_feat, b13_feat, b14_feat, b15_feat, b16_feat,  = torch.chunk(b1_feat, 6, dim=2)
        ...
        if self.training:
            ...
            b11_outputs = self.b1_head(b11_feat, targets)
            b12_outputs = self.b2_head(b12_feat, targets)
            b13_outputs = self.b21_head(b13_feat, targets)
            b14_outputs = self.b21_head(b14_feat, targets)
            b15_outputs = self.b3_head(b15_feat, targets)
            b16_outputs = self.b31_head(b16_feat, targets)
            ...
            losses = self.losses(b11_outputs,
                                 b12_outputs, b13_outputs, b14_outputs,
                                 b15_outputs, b16_outputs,
                                 targets)
            return losses
        else:
            b11_pool_feat = self.b1_head(b11_feat)
            b12_pool_feat = self.b2_head(b12_feat)
            b13_pool_feat = self.b21_head(b13_feat)
            b14_pool_feat = self.b21_head(b14_feat)
            b15_pool_feat = self.b3_head(b15_feat)
            b16_pool_feat = self.b31_head(b16_feat)
            # b32_pool_feat = self.b32_head(b32_feat)
            # b33_pool_feat = self.b33_head(b33_feat)

            pred_feat = torch.cat([b11_pool_feat, b12_pool_feat, b13_pool_feat,
                                   b14_pool_feat, b15_pool_feat, b16_pool_feat], dim=1)
            return pred_feat
    ...
    def losses(self,
               ...
               b3_outputs, b31_outputs,  gt_labels):
        # model predictions
        # fmt: off
        ...
        if "TripletLoss" in loss_names:
            ...
            loss_dict['loss_triplet_b21'] = triplet_loss(
                b21_pool_feat,
                gt_labels,
                tri_kwargs.get('margin'),
                tri_kwargs.get('norm_feat'),
            ...
            loss_dict['loss_triplet_b31'] = triplet_loss(
                b31_pool_feat,
                gt_labels,
